...
same time, while usually having an end condition, \eg the target vertex being reached or having reached the border of a search going in the opposite direction.
...
need to deal with a global state, \eg set of visited vertices.
