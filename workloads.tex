...
\paragraph{Keywords.} The notation uses a small set of keywords: \textsf{UNWIND} that unnest a list, \ie produces a set of one-tuples (\eg UNWIND $ [1, 2, 3] $ results in $ \{ \tuple{1}, \tuple{2}, \tuple{3} \} $). Aggregation operations: \textsf{count}, \textsf{sf}z
