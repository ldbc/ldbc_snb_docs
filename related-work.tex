...
\begin{enumerate}
\item transactional workloads consisting of interactive read and update queries (OLTP) aiming at graph databases that explore small portions of the graph in each query~\cite{DBLP:conf/cidr/BarahmandG13,DBLP:conf/sigmod/ArmstrongPBC13,DBLP:conf/sigmod/ErlingALCGPPB15},
...
\mbox{XDGBench} is described in~\cite{DBLP:journals/ase/DayarathnaS14}.
