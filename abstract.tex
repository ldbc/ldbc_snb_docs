...
and the business intelligence workload (analytical queries). This document
contains a detailed explanation of the data used in the \ldbcsnb
benchmark, a detailed description for all the Interactive and Business
Intelligence Workload queries, and instructions on how to generate the data and
run the benchmark with the provided software.  }
