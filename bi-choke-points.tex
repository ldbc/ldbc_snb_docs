...
\todo{Interactive has more: 2.5, 2.6 and 2.7}
...
\todo{Interactive has 3.4 and 3.5}
...
\todo{Interactive 4.3 is different: ``CP4.3 String Matching Performance.''}
...
\todo{Interactive 5.3 has the same content but a different name: ``Overlap between Outer-and Subquery.''}
...
\subsubsection{SNBI 7.1: [QEXE] Path pattern reuse}
