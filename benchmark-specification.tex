  ...
  \item \textbf{CSV variants:}
    \begin{itemize}
      ...
      \item \textbf{CSVMergeForeign:} Similar to the CSV format, but the 
        relations of the form 1-to-1 and 1-to-N are stored in the entity file as
        a foreign keys.
      \item \textbf{CSVComposite:} Similar to the CSV format, but uses composite attributes for storing the \texttt{Person.email}, and \texttt{Person.speaks} attributes.
