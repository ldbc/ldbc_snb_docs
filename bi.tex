...
First, systems should efficiently filter the \tKnows edges based on the location of their endpoint \tPersons (\tCountry \param{c}) and the date range.
...
(starting from \param{p2}), such as Dijkstra's algorithm, can be used.
