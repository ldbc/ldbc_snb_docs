...
The BI workload currently does not define update operations. However, this is subject to future research and the task force is working on determining possible update scenarios.
