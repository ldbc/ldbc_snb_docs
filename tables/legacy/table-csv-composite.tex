\begin{table}[htb]
    ...
    \begin{tabularx}{\linewidth}{|>{\sffamily}c|>{\tt}l|>{\tt}X|}
        ...
        \hline
    \end{tabularx}
    \caption{Files output by the CsvComposite serializer (31 in total). The first part of the table contains the static entities, the second part contains the dynamic ones.
