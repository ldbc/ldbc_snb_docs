\begin{table}[htb]
    ...
    \end{tabularx}
    \caption{Files output by the CsvMergeForeign serializer (20 in total). The first part of the table contains the static entities, the second part contains the dynamic ones.
