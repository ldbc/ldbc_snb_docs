...
Intelligence and Analytics. \todo{Analytics already has been introduced \& published, BI is WIP. ALso, I think Analytics is no longer considered to be a part of the SNB, as it only uses the DATAGEN component} By designing three separate workloads, \ldbcsnb
...
\todo{Update the next paragraphs}

In \autoref{section:workloads}, the Interactive Workload is proposed.
