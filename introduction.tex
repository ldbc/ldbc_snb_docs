...
Intelligence and Analytics. \todo{Analytics already has been introduced, BI is WIP} By designing three separate workloads, LDBC-SNB
...
LDBC-SNB provides an execution test driver, which is responsible for executing
