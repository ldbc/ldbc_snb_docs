...
\begin{itemize}
    ...
    \item Datagen: \url{https://github.com/ldbc/ldbc_snb_datagen/}
    \item Reference implementations (in Cypher and SQL): \url{https://github.com/ldbc/ldbc_snb_implementations/}
\end{itemize}
