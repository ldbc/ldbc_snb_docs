...
\begin{itemize}
    ...
    \item The SUT shall pass the ACID test suite (\autoref{sec:acid-test-suite}).
\end{itemize}

\subsubsection{Full Disclosure Report}
\label{sec:bi-fdr}
