...
Individual SNB workloads are expected to specify their policy of either using a domain-specific query language or implementing the queries in a general-purpose programming language.
