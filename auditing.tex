...
\begin{itemize}
    \item The \emph{power test} first runs the write operations, followed by sequential execution of individual read query variants (Q1, Q2a, Q2b, Q3, \ldots, Q20a, Q20b). Each query variant is executed using 30~different substitution parameters.
