...
% Explicit join orders are allowed in a declarative query if the application has a clear OLTP nature.
% Consider for example TPC-C, where implementations are known to specify join orders and indices.
...
%Additionally, the analytics workloads more diverse due to the rich set of operations executable on a property graph.
