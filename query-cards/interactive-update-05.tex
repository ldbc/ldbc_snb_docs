...
%
	...
	\cellcolor{black!70} \color{white} $\mathsf{2}$ & \varname{Forum-hasMember->Person.id} & \cellcolor{gray!20} \vartype{ID} &  \\ \hline
	\cellcolor{black!70} \color{white} $\mathsf{3}$ & \varname{Forum-hasMember->.joinDate} & \cellcolor{gray!20} \vartype{DateTime} &  \\ \hline
