...
$ &  \\ \hline
	...
	%
	relevance &
		\footnotesize This query looks for paths of length two or three, starting from a *Person*, moving to friends or friends of friends, and ending at a *Company*. In this query, there are selective joins and a top-k order by that can be exploited for optimizations.
 \\ \hline%
\end{tabularx}
\queryCardVSpace
