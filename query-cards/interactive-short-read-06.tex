...
%
		...
		$\mathsf{1}$ & Message\textless{}-containerOf-Forum.id
 & ID
 & R &
				 \\ \hline
		$\mathsf{2}$ & Message\textless{}-containerOf-Forum.title
 & String
 & R &
				 \\ \hline
		$\mathsf{3}$ & Message\textless{}-containerOf-Forum-hasModerator-\textgreater{}Person.id
 & ID
 & R &
				 \\ \hline
		$\mathsf{4}$ & Message\textless{}-containerOf-Forum-hasModerator-\textgreater{}Person.firstName
 & String
 & R &
				 \\ \hline
		$\mathsf{5}$ & Message\textless{}-containerOf-Forum-hasModerator-\textgreater{}Person.lastName
 & String
 & R &
				 \\ \hline
		\end{tabularx}}\innerCardVSpace \\ \hline
