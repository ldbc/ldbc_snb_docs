...
%
    pattern     & \hfill\includegraphics[scale=\patternscale,margin=0cm .2cm]{patterns/interactive05}\hfill\vadjust{} \\ \hline
%
...
%
	...
	\cellcolor{black!70} \color{white} $\mathsf{2}$ & \varname{count} & \cellcolor{gray!20} \vartype{32-bit Integer} & number of Posts made in Forum that were created by friends \\ \hline
	\end{tabularx}}\vspace{1.1ex} \\ \hline
	%
	sort        &
