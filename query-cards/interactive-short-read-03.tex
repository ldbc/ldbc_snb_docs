...
%
	...
	\cellcolor{black!70} \color{white} $\mathsf{4}$ & \varname{Knows.creationDate} & \cellcolor{gray!20} \vartype{DateTime} &  \\ \hline
	\end{tabularx}}\vspace{1.1ex} \\ \hline
	%
	sort        &
	\vspace{1.1ex}{\begin{tabular}{|c|l|c|} \hline
	\cellcolor{black!70} \color{white} $\mathsf{1}$ & \varname{Knows.creationDate} & \cellcolor{gray!20} $\desc$ \\ \hline
