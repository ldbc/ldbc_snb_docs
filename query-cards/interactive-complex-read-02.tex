...
%
	title & Recent messages by your friends \\ \hline
%
	pattern & \centering \includegraphics[scale=\patternscale,margin=0cm .2cm]{patterns/interactive-complex-read-02} \tabularnewline \hline
%
	desc. & Given a start Person, find (the most recent) Messages from all of that
