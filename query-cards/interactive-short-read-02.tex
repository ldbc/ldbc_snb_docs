...
%
		...
		$\mathsf{3}$ & Message.creationDate & DateTime & R &
				 \\ \hline
		$\mathsf{4}$ & Post.id or Comment-replyOf*->Post.id & ID & R &
				 \\ \hline
		$\mathsf{5}$ & asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf  & ID & R &
				 \\ \hline
		$\mathsf{6}$ & Post-hasCreator->Person.firstName or Comment-replyOf*->Post-hasCreator->Person.firstName & String & R &
				 \\ \hline
		$\mathsf{7}$ & Post-hasCreator->Person.lastName or Comment-replyOf*->Post-hasCreator->Person.lastName & String & R &
				 \\ \hline
		\end{tabularx}}\innerCardVSpace \\ \hline
...
%
		...
		$\mathsf{2}$ & Message.id & $\desc$ \\ \hline
