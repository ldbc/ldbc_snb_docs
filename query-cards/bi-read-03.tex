...
%
	...
	\cellcolor{result} \color{white} $\mathsf{1}$ & \varname{tag.name} & \cellcolor{gray!20} \vartype{String} &
	    \texttt{R} &
	     \\ \hline
	\cellcolor{result} \color{white} $\mathsf{2}$ & \varname{countMonth1} & \cellcolor{gray!20} \vartype{32-bit Integer} &
	    \texttt{A} &
	    occurrences of the tag during year-month 1 \\ \hline
	\cellcolor{result} \color{white} $\mathsf{3}$ & \varname{countMonth2} & \cellcolor{gray!20} \vartype{32-bit Integer} &
	    \texttt{A} &
	    occurrences of the tag during year-month 2 \\ \hline
	\cellcolor{result} \color{white} $\mathsf{4}$ & \varname{diff} & \cellcolor{gray!20} \vartype{32-bit Integer} &
	    \texttt{A} &
