...
%
        ...
        \cellcolor{parameter} \color{white} \footnotesize $\mathsf{1}$ &person1Id& 64-bit Integer &  \\ \hline
        \cellcolor{parameter} \color{white} \footnotesize $\mathsf{2}$ &person2Id& 64-bit Integer &  \\ \hline
        \cellcolor{parameter} \color{white} \footnotesize $\mathsf{3}$ &startDate& Date &  \\ \hline
        \cellcolor{parameter} \color{white} \footnotesize $\mathsf{4}$ &endDate& Date &  \\ \hline
