...
%
	...
	\cellcolor{parameter} \color{white} $\mathsf{1}$ & \varname{person1Id} & \cellcolor{gray!20} \vartype{64-bit Integer} &  \\ \hline
	\cellcolor{parameter} \color{white} $\mathsf{2}$ & \varname{person2Id} & \cellcolor{gray!20} \vartype{64-bit Integer} &  \\ \hline
	\cellcolor{parameter} \color{white} $\mathsf{3}$ & \varname{startDate} & \cellcolor{gray!20} \vartype{Date} &  \\ \hline
	\cellcolor{parameter} \color{white} $\mathsf{4}$ & \varname{endDate} & \cellcolor{gray!20} \vartype{Date} &  \\ \hline
	\end{tabularx}}\vspace{1.1ex} \\ \hline
%
	
	result      &
	\vspace{1.1ex}{\begin{tabularx}{14.2cm}{|c|M|m{2cm}|Y|} \hline
	\cellcolor{result} \color{white} $\mathsf{1}$ & \varname{person.id} & \cellcolor{gray!20} \vartype{64-bit Integer} & Identifiers representing an ordered sequence of the Persons in the path weight \\ \hline
	\end{tabularx}}\vspace{1.1ex} \\ \hline
