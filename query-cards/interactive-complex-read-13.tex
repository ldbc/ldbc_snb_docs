...
%
	...
	%
	relevance &
		\footnotesize This query looks for a variable length path, starting at a given *Person* and finishing at an another given *Person*. Proper cardinality estimation and search space prunning, will be crucial. This query also allows for possible parallel implementations.
 \\ \hline%
\end{tabularx}
\queryCardVSpace
