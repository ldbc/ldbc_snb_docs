...
%
 ...
 & String
 & R &
				post/comment (in lowercase)
 \\ \hline
		$\mathsf{3}$ & lengthCategory
 & String
 & R &
				short/one-liner/tweet/long (in lowercase)
 \\ \hline
		$\mathsf{4}$ & messageCount
 & 32-bit Integer
 & R &
				total number of Messages (Posts/Comments) in that group
 \\ \hline
		$\mathsf{5}$ & averageMessageLength
 & 32-bit Integer
 & R &
				average length of the Message content in that group
 \\ \hline
 ...
 & 32-bit Float
 & R &
				number of messages in group as a percentage of all messages created
...
%
 ...
 & $\desc
$ \\ \hline
		$\mathsf{2}$ & message type
 & $\asc
$ \\ \hline
		$\mathsf{3}$ & size category
 & $\asc
$ \\ \hline
