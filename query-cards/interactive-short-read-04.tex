...
%
	title & Content of a message \\ \hline
%
	pattern & \centering \includegraphics[scale=\patternscale,margin=0cm .2cm]{patterns/interactive-short-read-04} \tabularnewline \hline
%
	desc. & Given a \emph{Message}, retrieve its content and creation date.
 \\ \hline
%
