...
%
	...
	result      &
	\vspace{1.1ex}{\begin{tabularx}{14.2cm}{|c|M|m{2cm}|Y|} \hline
	\cellcolor{result} \color{white} $\mathsf{1}$ & \varname{messageCount} & \cellcolor{gray!20} \vartype{32-bit Integer} & number of messages created \\ \hline
	\cellcolor{result} \color{white} $\mathsf{2}$ & \varname{personCount} & \cellcolor{gray!20} \vartype{32-bit Integer} & the number of Persons with `messageCount` messages \\ \hline
	\end{tabularx}}\vspace{1.1ex} \\ \hline
