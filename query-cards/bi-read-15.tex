...
%
	pattern & \centering \includegraphics[scale=\patternscale,margin=0cm .2cm]{patterns/bi-read-15} \tabularnewline \hline
%
	desc. & Given a \emph{Country} \texttt{country}, determine the ``social
