...
%
	title & Replies of a message \\ \hline
%
	pattern & \centering \includegraphics[scale=\patternscale,margin=0cm .2cm]{patterns/interactive-short-read-07} \tabularnewline \hline
%
	desc. & Given a \emph{Message}, retrieve the (1-hop) \emph{Comments} that reply
to it.
...
%
 ...
 \\ \hline
		$\mathsf{7}$ & knows & Boolean & C &
				\texttt{reply\+Author\+Knows\+Original\+Message\+Author}
 \\ \hline
		\end{tabularx}}\innerCardVSpace \\ \hline
...
%
 ...
 & $\desc
$ &  \\ \hline
		$\mathsf{2}$ & Comment-hasCreator-\textgreater{}Person.id
 & $\asc
$ &  \\ \hline
		\end{tabularx}}\innerCardVSpace \\ \hline
	%
