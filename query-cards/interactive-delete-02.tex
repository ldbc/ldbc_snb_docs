...
\subsection{Interactive / delete / 2}
\label{sec:interactive-delete-02}
...
%
	desc. & Given a \emph{Person} \textbf{node} and a \emph{Post} \textbf{node}, remove a \emph{likes} edge between them. 
 \\ \hline
%
