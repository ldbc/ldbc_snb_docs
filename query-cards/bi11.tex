...
retrieve the number of likes on the reply.
 \\ \hline
	...
	\cellcolor{black!70} \color{white} $\mathsf{ 1 }$ & \varname{country} & \cellcolor{gray!20} \vartype{32bitInteger} & \\ \hline
	...
	\cellcolor{black!70} \color{white} $\mathsf{ 3 }$ & \varname{countLikes} & \cellcolor{gray!20} \vartype{32bitInteger} &The count of Likes to replies with that Tag. \\ \hline
	\cellcolor{black!70} \color{white} $\mathsf{ 4 }$ & \varname{countReplies} & \cellcolor{gray!20} \vartype{32bitInteger} &The count of replies with that Tag. \\ 
	\end{tabularx}} \\ \hline
	sort        &
	\renewcommand*{\arraystretch}{1.0}
