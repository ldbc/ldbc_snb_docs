...
%
    pattern     & \hfill\includegraphics[scale=\patternscale,margin=0cm .2cm]{patterns/bi11}\hfill\vadjust{} \\ \hline
%
...
%
	...
	\cellcolor{black!70} \color{white} $\mathsf{2}$ & \varname{blacklist} & \cellcolor{gray!20} \vartype{String[]} &  \\ \hline
...
%
	...
	\cellcolor{black!70} \color{white} $\mathsf{4}$ & \varname{countReplies} & \cellcolor{gray!20} \vartype{32-bit Integer} & The count of replies with that Tag. \\ \hline
	\end{tabularx}}\vspace{1.1ex} \\ \hline
	%
	sort        &
	...
	\cellcolor{black!70} \color{white} $\mathsf{3}$ & \varname{tag.name} & \cellcolor{gray!20} $\asc$ \\ \hline
