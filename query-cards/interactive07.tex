...
%
	...
	\cellcolor{black!70} \color{white} $\mathsf{8}$ & \varname{isNew} & \cellcolor{gray!20} \vartype{Boolean} & false if liker Person is friend of start Person, true otherwise \\
	\end{tabularx}} \\ \hline
	%
	sort        &
