...
%
	...
	\cellcolor{result} \color{white} $\mathsf{2}$ & \varname{replyCount} & \cellcolor{gray!20} \vartype{32-bit Integer} &  \\ \hline
	\cellcolor{result} \color{white} $\mathsf{3}$ & \varname{likeCount} & \cellcolor{gray!20} \vartype{32-bit Integer} &  \\ \hline
	\cellcolor{result} \color{white} $\mathsf{4}$ & \varname{postCount} & \cellcolor{gray!20} \vartype{32-bit Integer} &  \\ \hline
	\cellcolor{result} \color{white} $\mathsf{5}$ & \varname{score} & \cellcolor{gray!20} \vartype{32-bit Integer} &  \\ \hline
	\end{tabularx}}\vspace{1.1ex} \\ \hline
