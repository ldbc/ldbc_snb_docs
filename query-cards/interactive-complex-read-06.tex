...
%
	pattern & \centering \includegraphics[scale=\patternscale,margin=0cm .2cm]{patterns/interactive-complex-read-06} \tabularnewline \hline
%
	desc. & Given a start \emph{Person} and some \emph{Tag}, find the other
...
%
 ...
 \\ \hline
		$\mathsf{2}$ & postCount & 32-bit Integer & A &
				\texttt{postCount} -- Number of \emph{Posts} that were created by
friends and friends of friends, which contain this \emph{Tag}
 \\ \hline
		\end{tabularx}}\innerCardVSpace \\ \hline
...
$ &  \\ \hline
	...
	%
	relevance &
		\footnotesize This query looks for paths of lengths three or four, starting from a
given \emph{Person}, moving to friends or friends of friends, then to
\emph{Posts} and finally ending at a given \emph{Tag}.
 \\ \hline%
\end{tabularx}
\queryCardVSpace
