...
$ &  \\ \hline
	...
	%
	relevance &
		\footnotesize This query looks for paths of lengths three or four, starting from a given *Person*, moving to friends or friends of friends, then to *Posts* and finally ending at a given *Tag*.
 \\ \hline%
\end{tabularx}
\queryCardVSpace
