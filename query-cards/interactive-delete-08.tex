...
comments &
\begin{itemize}
    \item In principle, a person can only post to a Person's Wall if they are
      friends. If such friendship is removed, should we remove the comments of a
      person mad into the removed friend's wall?
\end{itemize}
