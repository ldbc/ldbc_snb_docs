...
%
	...
	\cellcolor{result} \color{white} \footnotesize $\mathsf{1}$ & \varname{year} & \cellcolor{gray!20} \vartype{32-bit Integer} &
	    \texttt{C} &
	    year(message.creationDate) \\ \hline
	\cellcolor{result} \color{white} \footnotesize $\mathsf{2}$ & \varname{month} & \cellcolor{gray!20} \vartype{32-bit Integer} &
	    \texttt{C} &
	    month(message.creationDate) \\ \hline
	\cellcolor{result} \color{white} \footnotesize $\mathsf{3}$ & \varname{popularTags} & \cellcolor{gray!20} \vartype{TagPairs} &
	    \texttt{C} &
