...
%
	...
	\cellcolor{parameter} \color{white} \footnotesize $\mathsf{2}$ & \varname{blacklist} & \cellcolor{gray!20} \vartype{String[]} &  \\ \hline
...
%
	...
	\cellcolor{result} \color{white} \footnotesize $\mathsf{2}$ & \varname{tag.name} & \cellcolor{gray!20} \vartype{String} &
	    \texttt{R} &
	     \\ \hline
	\cellcolor{result} \color{white} \footnotesize $\mathsf{3}$ & \varname{countLikes} & \cellcolor{gray!20} \vartype{32-bit Integer} &
	    \texttt{A} &
	    The count of Likes to replies with that Tag. \\ \hline
	\cellcolor{result} \color{white} \footnotesize $\mathsf{4}$ & \varname{countReplies} & \cellcolor{gray!20} \vartype{32-bit Integer} &
	    \texttt{A} &
...
%
	...
	\cellcolor{sort} \color{white} \footnotesize $\mathsf{1}$ & \varname{countLikes} & \cellcolor{gray!20} $\desc$ \\ \hline
	\cellcolor{sort} \color{white} \footnotesize $\mathsf{2}$ & \varname{person.id} & \cellcolor{gray!20} $\asc$ \\ \hline
	\cellcolor{sort} \color{white} \footnotesize $\mathsf{3}$ & \varname{tag.name} & \cellcolor{gray!20} $\asc$ \\ \hline
