...
%
	...
	\cellcolor{result} \color{white} $\mathsf{2}$ & \varname{tag.name} & \cellcolor{gray!20} \vartype{String} &  \\ \hline
	\cellcolor{result} \color{white} $\mathsf{3}$ & \varname{countLikes} & \cellcolor{gray!20} \vartype{32-bit Integer} & The count of Likes to replies with that Tag. \\ \hline
	\cellcolor{result} \color{white} $\mathsf{4}$ & \varname{countReplies} & \cellcolor{gray!20} \vartype{32-bit Integer} & The count of replies with that Tag. \\ \hline
	\end{tabularx}}\vspace{1.1ex} \\ \hline
