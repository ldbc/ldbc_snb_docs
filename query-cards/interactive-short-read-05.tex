...
%
	title & Creator of a message \\ \hline
%
	pattern & \centering \includegraphics[scale=\patternscale,margin=0cm .2cm]{patterns/interactive-short-read-05} \tabularnewline \hline
%
	desc. & Given a \emph{Message}, retrieve its author.
 \\ \hline
%
