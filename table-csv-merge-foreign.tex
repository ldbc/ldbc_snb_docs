\begin{table}[htb]
    ...
    \centerline{\begin{tabular}{|c|p{4.3cm}|p{12.4cm}|}
    	\hline
    	\tableHeaderFirst{En.}  & \tableHeader{File}                   & \tableHeader{Content}                                                                                               \\
    	\hline\hline
        N                       & organisation\_*.csv                  & id | type({"university", "company"}) | name | url | place                                                           \\
        \hline
        N                       & place\_*.csv                         & id | name | url | type({"city", "country", "continent"}) | isPartOf                                                 \\
        \hline
        ...
        \hline
    \end{tabular}}
    \caption{Files output by the CsvMergeForeign serializer (20 in total). Notation -- K: entity kind, T: entity type, N: Node, E: Edge, A: Attribute.}
