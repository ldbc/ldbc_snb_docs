\begin{figure*}[htp]
  ...
  \begin{subfigure}{\linewidth}
    \vspace{-2ex}
    \input{figures/fig-comments-graph-replica}
    ...
    \label{fig:comments-graph-replica}
  \end{subfigure}
  %
  \begin{subfigure}{\linewidth}
    \centering
    \footnotesize
    \begin{tikzpicture}[node distance=2cm,thick,scale=0.75,every node/.style={transform shape}]
      % timeline
