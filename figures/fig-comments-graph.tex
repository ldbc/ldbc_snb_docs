...
\begin{tikzpicture}[node distance=4cm,scale=0.85,every node/.style={transform shape}]
  ...
  (person1);
  \draw [edge] (forum) to [out=175,in=-45] node [midway,above,sloped] {\scriptsize{$\instance{hmem_{1}} : \type{hasMember}$}} (person1);
  \draw [edge] (forum) to [out=-155,in=-25]
  node [midway,above] {\scriptsize{$\instance{hmem_{2}} : \type{hasMember}$}}
  node [midway,below,yshift=0cm,align=center,text width=3.5cm] {\scriptsize{\texttt{$\instc{hmem}{2}$: Jun 15 2010}}}
  node [midway,below,yshift=-0.4cm,align=center,text width=3.5cm] {\scriptsize{\texttt{$\instd{hmem}{2}$: Jul 26 2012}}}
  (person2);

  \draw [edge] (forum) --
  node [midway,above,xshift=1.2cm,yshift=0.5cm] {\scriptsize{$\instance{hmem_{3}} : \type{hasMember}$}}
  node [midway,above,xshift=1cm,yshift=0.1cm,align=right,text width=2.8cm] {\scriptsize{\texttt{$\instc{hmem}{3}$: Dec 08 2010}}}
  node [midway,above,xshift=1cm,yshift=-0.3cm,align=right,text width=2.8cm] {\scriptsize{\texttt{$\instd{hmem}{3}$: Feb 29 2012}}} (person3);
  ...
  \draw [edge] (comment1) to [out=0,in=180] node [midway,above,grey] {\scriptsize{$\instance{ROF_{2}} : \type{replyOf}$}} (comment2);
