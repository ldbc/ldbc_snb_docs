...
\begin{tikzpicture}[node distance=4cm,scale=0.85,every node/.style={transform shape}]
  ...
  node [midway,above,xshift=1.2cm,yshift=0.6cm,align=center,text width=2.8cm] {\scriptsize{\texttt{$\instc{hmod}{}$: Apr 01 2010}}}
  node [midway,above,xshift=1.2cm,yshift=0.2cm,align=center,text width=2.8cm] {\scriptsize{\texttt{$\instd{hmod}{}$: Oct 02 2012}}}
  (person1);
  ...
  node [midway,below,yshift=-0.5cm,align=center,text width=3.5cm] {\scriptsize{\texttt{$\instc{hmem}{2}$: Jun 15 2010}}}
  node [midway,below,yshift=-0.9cm,align=center,text width=3.5cm] {\scriptsize{\texttt{$\instd{hmem}{2}$: Jul 26 2012}}}
  (person2);

  \draw [edge] (forum) --
  node [midway,above,xshift=1.5cm,yshift=0.5cm] {\scriptsize{$\instance{hmem_{3}} : \type{hasMember}$}}
  node [midway,above,xshift=1.5cm,yshift=0.1cm,align=right,text width=2.8cm] {\scriptsize{\texttt{$\instc{hmem}{3}$: Dec 08 2010}}}
  node [midway,above,xshift=1.5cm,yshift=-0.3cm,align=right,text width=2.8cm] {\scriptsize{\texttt{$\instd{hmem}{3}$: Feb 29 2012}}} (person3);
