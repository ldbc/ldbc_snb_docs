...
\autoref{tab:number-of-entities-bi-raw} shows some metrics of SFs 0.1, \ldots, \numprint{1000} data sets.
...
Interactive complex reads (\queryRefCard{interactive-complex-read-01}{IC}{1}--\queryRefCard{interactive-complex-read-14-new}{IC}{14-n}) and
