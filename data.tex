...
The workflow of the benchmark is shown in \autoref{fig:workflow}.
...
This paper focuses on the challenge of generating deletion operations within LDBC's synthetic data generator, specifically, to extend the generator with support for dynamic entities.
...
This section is based on the paper at the GRADES-NDA~2020 workshop~\cite{DBLP:conf/sigmod/WaudbySPS20} by the task force members.
