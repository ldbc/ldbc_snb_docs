...
\begin{itemize}
    ...
    \item \textbf{LDBC\_SOCIALNET\_DATAGEN\_HOME}: Points to your DATAGEN root folder.
\end{itemize}
...
exist. If there is not an HDFS file system mounted, then data is output to your local
file system. 
